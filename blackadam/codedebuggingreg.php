...
<div class="row">
    ...
    <h1>Registration Form of CODE DEBUGGING</h1>
    <div class="container">
        <form action="" method="post">
            <h1>Please enter the field to register in CODE DEBUGGING-Blackadam</h1>
...
if (isset($_POST["sub"])){
    ...
    if(mysqli_num_rows($result)==1){
        ...
        {
            echo "<script>alert('You have already registered in Code Debugging')</script><br>";
        }
