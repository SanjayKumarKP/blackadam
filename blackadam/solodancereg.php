...
<div class="row">
    ...
    <h1>Registration Form of SOLO DANCE</h1>
    <div class="container">
        <form action="" method="post">
            <h1>Please enter the field to register in SOLO DANCE-Blackadam</h1>
...
if (isset($_POST["sub"])){
    ...
    if(mysqli_num_rows($result)==1){
        ...
        {
            echo "<script>alert('You have already registered in Solo Dance')</script><br>";
        }
