...
<div class="row">
    ...
    <h1>Registration Form of Paper Presentation</h1>
    <div class="container">
        <form action="" method="post">
            <h1>Please enter the field to register in Paper Presentation-Blackadam</h1>
...
if (isset($_POST["sub"])){
    ...
    if(mysqli_num_rows($result)==1){
        ...
        {
            echo "<script>alert('You have already registered in Paper Presentation')</script><br>";
        }
