...
<div class="row">
    ...
    <h1>Registration form of GROUP DANCE</h1>
    <div class="container">
        <form action="" method="POST">
            <h1>Please enter the fields to register in GROUP DANCE-Blackadam</h1>
   ...
   // print_r($_POST["user"]);
    ...
    if($tright==1)
    {
        ...
        {   
            ...
            if($j==$i)
            {
                echo "<script>alert('Succesfully registered your team in Group Dance')</script>";
            }
