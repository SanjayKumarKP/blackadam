...
<head>
    ...
    <title>BLACKADAM-PRESENTATION</title>
    <link rel="shortcut icon" type="image/x-icon" href="images/blackadam-logo.JPG">   <!-- icon shown on top of heading of admin page -->
...
<body
    style="background:linear-gradient(rgba(47, 23, 15, 0.65), rgba(47, 23, 15, 0.65)), url('assets/img/presentationback.jpg');">
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span
            class="text-primary site-heading-upper mb-3"> Presented by Perspectives, Debating society of MEC&nbsp;</span>
        <span class="site-heading-lower">Presentation Events</span></h1>
 ...
 <!-- first event -->
    <section class="page-section clearfix">
        <div class="container">
            ...
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/paperpresentation.jpg"
                    style="width: 59%; ">
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    <h2 class="section-heading mb-4"><span class="section-heading-upper">Solo event</span><span
                            class="section-heading-lower">PAPER PRESENTATION</span></h2>
                    ...
                    <div class="mx-auto intro-button"><a class="btn btn-primary d-inline-block mx-auto btn-xl"
                            role="button" onclick="location.href='paperpresentationreg.php'">Register Now!</a></div>
                </div>
            </div>
        </div>
    </section>
...
<!-- second event -->
    <section class="page-section clearfix">
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/projectpresentation.jpg"
                    style="width: 59%;">
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    <h2 class="section-heading mb-4"><span class="section-heading-upper">Group event</span><span
                            class="section-heading-lower">PROJECT PRESENTATION</span></h2>
                    ...
                    <div class="mx-auto intro-button"><a class="btn btn-primary d-inline-block mx-auto btn-xl"
                            role="button" onclick="location.href='projectpresentationreg.php'">Register Now!</a></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="footer text-faded text-center py-5">
        <div class="container">
            <p class="m-0 small">With Love&nbsp;©&nbsp;Blackadam 2022</p>
        </div>
    </footer>
