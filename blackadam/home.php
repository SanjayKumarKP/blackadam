        ...
        <div class="container-fluid">
          <div class="row align-items-center">
            <div class="col-10 col-lg-4">
              ...
              <!-- to go to SE website -->
                <a href="http://www.mahendra.info/">MEC presents</a>
            ...
            <div class="col-12">
              <nav class="site-navigation">
                ...
                <!-- nav bar URLS to go to different pages -->
                  <li><a href="danceevents.php">Dance Events</a></li>
                  <li><a href="musicevents.php">Music Events</a></li>
                  <li><a href="codingevents.php">Coding Events</a></li>
                  <li><a href="presentationevents.php">Presentation Events</a></li>
                  <li><a href="plogin.php">You in BLACKADAM</a></li>
                ...
                <div class="lineup-artists-description">
                  <div class="lineup-artists-description-container">
                    ...
                    <div class="entry-content">
                      ...
                      is an Indian-American business executive. 
                      He is the chief executive officer of Alphabet Inc. 
                      and its subsidiary Google. Born in Madurai, India, 
                ...
                <div class="lineup-artists-description">
                  ...
                  <div class="lineup-artists-description-container">
                    ...
                    <div class="entry-content">
                      ...
                      He is known for co-founding the social media website Facebook and 
                      its parent company Meta Platforms, of which he is the chairman, 
...
<!-- sponsors begin -->
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="entry-mail">
                <a href="#">SAYHELLO@BLACKADAM.COM</a>
              </div>
              ...
              <div class="copyright-info">
                ...
                <a href="home.php" target="_blank">SANJAY KUMAR</a>
              </div>
    ...
    // script for countdown
      ...
      var countDownDate = new Date("September 05, 2022 00:00:00").getTime();
