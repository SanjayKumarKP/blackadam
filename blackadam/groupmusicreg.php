...
<div class="row">
    ...
    <h1>Registration form of GROUP MUSIC</h1>
    <div class="container">
        <form action="" method="POST">
            <h1>Please enter the fields to register in GROUP MUSIC-Blackadam</h1>
   ...
   // print_r($_POST["user"]);
    ...
    if($tright==1)
    {
        if($mright==$i)
        {
            ...
            if($j==$i)
            {
                echo "<script>alert('Succesfully registered your team in Group Music')</script>";
            }
