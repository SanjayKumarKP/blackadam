...
<body
    ...
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span
            class="text-primary site-heading-upper mb-3"> Presented by Baila-Amor, Dance society of MEC&nbsp;</span>
            ...
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/solodance.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    <h2 class="section-heading mb-4"><span class="section-heading-upper">Solo event</span><span
                            class="section-heading-lower">SOLO DANCE</span></h2>
                    <p class="mb-3">Are u a passionate solo dancer . Come to Blackadam n show ur worth!!
                        <h6><br><b>VENUE-</b>
                            <?php
                                include "linc.php";
                    ...
                    <div class="mx-auto intro-button"><a class="btn btn-primary d-inline-block mx-auto btn-xl"
                            role="button" onclick="location.href='solodancereg.php'">Register Now!</a></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/groupdance.jpg"
                ...
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    <h2 class="section-heading mb-4"><span class="section-heading-upper">Group event</span><span
                            class="section-heading-lower">GROUP DANCE</span></h2>
                    <p class="mb-3">Love Dancing in groups? Come to Blackadam and engage all others to shake their body
                        with u !!
                        <h6><br><b>VENUE-</b> <?php
                                include "linc.php";
                    ...
                    <div class="mx-auto intro-button"><a class="btn btn-primary d-inline-block mx-auto btn-xl"
                            role="button" onclick="location.href='groupdancereg.php'">Register Now!</a></div>
                </div>
            </div>
        </div>
    </section>
