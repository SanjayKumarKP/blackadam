...
<div class="row">
    ...
    <input type="button" name="sub" class="fadeIn fourth" onclick="window.location.href='home.php'" value="Home">
    </div>
</div>

    <h1>Registration form of Project Presentation</h1>
    <div class="container">
        <form action="" method="POST">
            <h1>Please enter the fields to register in Project Presentation-Blackadam</h1>
   ...
   // print_r($_POST["user"]);
    ...
    if($tright==1)
    {
        if($mright==$i)
        {
            ...
            if($j==$i)
            {
                echo "<script>alert('Succesfully registered your team in Project Presentation')</script>";
            }
