...
<body
    style="background:linear-gradient(rgba(47, 23, 15, 0.65), rgba(47, 23, 15, 0.65)), url('assets/img/codingback.jpg');">
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span
            class="text-primary site-heading-upper mb-3"> Presented by MEC&nbsp;</span>
        <span class="site-heading-lower">Coding Events</span></h1>
 ...
 <!-- first event -->
    <section class="page-section clearfix">
        <div class="container">
            ...
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/codedebugging.jpg"
                    style="width: 59%; ">
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    <h2 class="section-heading mb-4"><span class="section-heading-upper">Solo event</span><span
                            class="section-heading-lower">Code Debugging</span></h2>
                    <p class="mb-3">Error spoting.
                        <h6><br><b>VENUE-</b><?php
                    ...
                    <div class="mx-auto intro-button"><a class="btn btn-primary d-inline-block mx-auto btn-xl"
                            role="button" onclick="location.href='codedebuggingreg.php'">Register Now!</a></div>
                </div>
            </div>
        </div>
    </section>
...
<!-- second event -->
    <section class="page-section clearfix">
        <div class="container">
            <div class="intro"><img class="img-fluid intro-img mb-3 mb-lg-0 rounded" src="assets/img/codingcontest.jpg"
                    style="width: 59%;">
                <div class="intro-text left-0 text-centerfaded p-5 rounded bg-faded text-center">
                    <h2 class="section-heading mb-4"><span class="section-heading-upper">Group event</span><span
                            class="section-heading-lower">Coding Contest</span></h2>
                    <p class="mb-3">Solve the problem. <br>  
                        <h6><br><b>VENUE-</b> <?php
                                include "linc.php";
                    ...
                    <div class="mx-auto intro-button"><a class="btn btn-primary d-inline-block mx-auto btn-xl"
                            role="button" onclick="location.href='codingcontestreg.php'">Register Now!</a></div>
                </div>
            </div>
        </div>
    </section>
