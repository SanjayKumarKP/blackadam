...
<head>
    ...
    <title>Add Chief Guest/Sponsor | BLACKADAM Admin</title>
    ...
    <div class="all-content-wrapper" >
		...
		<?php
			...
			if(isset($_POST["sub-but"]))
			{
				...
				// $passwd = "DK@BLACKADAM" ; //password according to useraccount created in database
        // $schema = "BLACKADAM" ; // to store database/schema wheree all relations are present
        include "linc.php";
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section"> <!--Creates white boundary for form area-->
                                        <div class="row">
                                        <p>
									<h4 align = "center"> Total   &nbsp;<?php echo($special); ?> &nbsp;are 
									<?php  print(mysqli_num_rows($result3)) ; ?>   </h4>           <!-- prints number of rows in relation Sponsors/Chief_Guests-->
								</p>
