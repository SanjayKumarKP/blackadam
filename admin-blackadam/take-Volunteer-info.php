...
<head>
    ...
    <title> Add Volunteer Details | Blackadam Admin</title>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
						  <h2 align="center">Enter Volunteer details below that are to be added.</h2><br><br>
                                            ...
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form  method ="POST" action= "add-Man_Vol.php" >
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																<div class="form-group" ><h3> Work Designation: </h3>
                                                                    <select name="work-Tag" class="form-control" >
                                                                      <option value="2" selected="">Volunteer</option>
                                                                    </select>
                                                                </div><br><br>
                                                                <div class="form-group" ><h3> Volunteer's Full Name: </h3>
