...
<head>
    ...
    <title>Add Sponsors Details | Blackadam Admin</title>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
						  <h2 align="center"> Enter Sponsor details below that are to be added.</h2> <br><br>
                                                    ...
                                                    <form  method ="POST" action= add-Chief_Sponsors.php >												
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group" ><h3>Organisation/Sponsor Full Name: </h3>
																...
																<div class="form-group" ><h3> Amount sponsored(INR) : </h3>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                                                                
                                                                <div class="form-group" ><h3> Representative Name To Be Contacted : </h3>
                                                                ...
                                                                <div class="form-group" ><h3> Account Number : </h3>
