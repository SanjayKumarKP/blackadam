...
<head>
    ...
    <title> Query Box | Blackadam Admin </title>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
							<p><h2 align="center"> Have your own MySQL query or want to see some other data from relation? <br> Type your MySQL query in the query box below</h2>
							</p> <br><br>
                                            ...
                                            <div class="review-content-section">
                                                <div class="pro-ad">
                                                    <form  method ="POST" action= "query_box_run.php" >												
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class='form-group'><h3> Enter your Query: </h3> <br>
																	<textarea name="query"> </textarea>
																</div>	
                                                            </div>
															
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group"><h3> Some available Queries may work for you:</h3>
