...
<head>
    ...
    <title>Edit Sponsor | BLACKADAM Admin </title>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
						  <h2 align="center"> Enter Sponsor details below that are to be edited.</h2>
                                                    ...
                                                    <form  method ="POST" action= edit-Relations.php>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																...
																<div class="form-group" ><h3> Representative Name: </h3>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
																...
																<div class="form-group" ><h3> Amount Sponsored in (INR) : </h3>
                                                                    <input name="amt" type="number" class="form-control" placeholder="Amount Sponsored">
                                                                </div><br><br>
																<div class="form-group" ><h3> Account No. of Sponsor/Organisation/Company : </h3>
