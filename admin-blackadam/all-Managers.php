...
<head>
    ...
    <title>All Managers | Blackadam Admin </title>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section"> 
                                        <div class="row">
                                        <p> <h4 align = "center"> There are  
									<?php  print(mysqli_num_rows($result2)) ?> managers. </h4>
								</p>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section"> 
                                        <div class="row">
													...
													<caption><h4> Results of query - <?php  print($query2); ?> &nbsp; are: </h4> </caption>
												<p><br>
													<table>
													<?php  
