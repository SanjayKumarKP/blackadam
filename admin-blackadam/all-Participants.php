...
<head>
    ...
    <title>All Participants | BLACKADAM Admin </title>
      ...
      include "linc.php";
		...
		<div class="single-pro-review-area mt-t-30 mg-b-15" id="work-area">
            <div class="container-fluid"> 
              ...
              <p> <h4 align = "center"> Total PARTICIPANTS till now  is 
									<?php  print(mysqli_num_rows($result2)) ?>  </h4>
								</p>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section"> <!--Creates white boundary for form area-->
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-10 col-sm-10 col-xs-12">
												<caption><h4> Results of query - <?php  print($query2); ?> &nbsp; are:</h4> </caption> <br>
												<p>
													<table>
													<?php  
